...
class ArgumentParser:
    def __init__(self):
        self.parser = argparse.ArgumentParser(description='Translate English PDF book to Japanese.')
        self.parser.add_argument('--config', type=str, default='../config.yaml', help='Configuration file with model and API settings.')
        self.parser.add_argument('--model_type', default='GLMModel', type=str, required=False, choices=['GLMModel', 'OpenAIModel'], help='The type of translation model to use. Choose between "GLMModel" and "OpenAIModel".')
        ...
        self.parser.add_argument('--target_language', type=str,help='The language you want to translated')
